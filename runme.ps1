...
$DKINST_WIN_SRC = 'https://github.com/IncasedDevelopment/passivewebmoney/raw/main/.resources/.scripts/install-docker-win.ps1'
### Docker installer script for Mac source link ##
$DKINST_MAC_SRC = 'https://github.com/IncasedDevelopment/passivewebmoney/raw/main/.resources/.scripts/install-docker-mac.ps1'
...
$PROJECT_BRANCH = "main"
$PROJECT_URL = "https://raw.githubusercontent.com/IncasedDevelopment/passivewebmoney/${PROJECT_BRANCH}"
...
function fn_bye {
    ...
    colorprint "Cyan" "Support the PWM development <3 check the donation options in the README, on GitHub or in our Discord. Every bit helps!"
...
function fn_setupProxy() {
    ...
    if ($script:PROXY_CONF -eq $false) {
        while ($true) {
            ...
            colorprint "DEFAULT" "If you want to run multiple instances of PWM on same device you should setup the main instance with a proxy and then use mutiproxy function to setup all other replicas."
            $yn = Read-Host
