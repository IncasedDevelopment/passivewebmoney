...
$ProgressPreference = 'Continue'
Write-Output "NOTE: IF YOU READ THIS MESSAGE YOU ARE USING AN OLD VERSION OF THE MONEY4BAND PROJECT. PLEASE DOWNLOAD THE LATEST VERSION FROM https://github.com/IncasedDevelopment/passivewebmoney"
